...
{
	if (playerFacing == 1 && map[charLocation.Y][charLocation.X+2] == '#' || map[charLocation.Y][charLocation.X+2] == 227 || map[charLocation.Y][charLocation.X+2] == 239 || map[charLocation.Y][charLocation.X+2] == 234 || map[charLocation.Y][charLocation.X+2] == 21 || map[charLocation.Y][charLocation.X+2] == 16 || map[charLocation.Y][charLocation.X+2] == 17 || map[charLocation.Y][charLocation.X+2] == 16 || map[charLocation.Y][charLocation.X+2] == 17  || map[charLocation.Y][charLocation.X+2] == 15 || map[charLocation.Y][charLocation.X+1] == '#' || map[charLocation.Y][charLocation.X+1] == 227 || map[charLocation.Y][charLocation.X+1] == 239 || map[charLocation.Y][charLocation.X+1] == 234 || map[charLocation.Y][charLocation.X+1] == 21 || map[charLocation.Y][charLocation.X+1] == 16 || map[charLocation.Y][charLocation.X+1] == 17 || map[charLocation.Y][charLocation.X+1] == 16 || map[charLocation.Y][charLocation.X+1] == 17  || map[charLocation.Y][charLocation.X+1] == 15)
	{
		cannotAttack = true;
	}
